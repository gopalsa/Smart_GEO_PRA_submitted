...
public class PraAdapter extends RecyclerView.Adapter<PraAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (pra.getTitle().equals("UBA Website")
                || pra.getTitle().equals("UBA 2.0 Project Guidelines")
                || pra.getTitle().equals("UBA News & Events")
                || pra.getTitle().equals("UBA Photos & Videos")) {
            holder.toolsLin.setVisibility(View.GONE);
        } else {
            holder.toolsLin.setVisibility(View.VISIBLE);
        }

        if (pra.getTitle().equals("UBA Team Members") || pra.getTitle().equals("UBA Village Secondary Info")) {
    ...
    private void titleClick(Pra pra, MyViewHolder holder) {
        ...
        if (pra.getTitle().equals("UBA Website")) {
            ...
            io.putExtra("link", "http://unnatbharatabhiyan.gov.in/");
