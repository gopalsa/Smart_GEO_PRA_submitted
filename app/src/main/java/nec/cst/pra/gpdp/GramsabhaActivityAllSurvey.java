...
public class GramsabhaActivityAllSurvey extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private GramsabhaAllSurveyAdapter mRecyclerAdapterMaster;
    private ArrayList<GramBean> itemArrayList = new ArrayList<GramBean>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gramsabha_all_survey);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);


        getSupportActionBar().setTitle("Gram sabha Details");
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GramsabhaActivityAllSurvey.this, GramsabhaActivity.class);
        ...
        mRecyclerAdapterMaster = new GramsabhaAllSurveyAdapter(this, itemArrayList);
    ...
    private void getAllData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                "http://climatesmartcity.com/UBA/get_gpdpgramsabha.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        itemArrayList = new ArrayList<GramBean>();
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                JSONObject dataObject = jsonArray.getJSONObject(i);
                                GramBean gramBean = new Gson().fromJson(dataObject.getString("data"), GramBean.class);
                                gramBean.setId(dataObject.getString("formId"));
                                itemArrayList.add(gramBean);
                            } catch (Exception e) {
