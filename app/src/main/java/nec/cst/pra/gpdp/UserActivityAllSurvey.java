...
public class UserActivityAllSurvey extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private UserAllSurveyAdapter mRecyclerAdapterMaster;
    private ArrayList<UserDetail> itemArrayList = new ArrayList<UserDetail>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_all_survey);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UserActivityAllSurvey.this, UserDetailActivity.class);
        ...
        mRecyclerAdapterMaster = new UserAllSurveyAdapter(this, itemArrayList);
    ...
    private void getAllData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                "http://climatesmartcity.com/UBA/get_gpdpuser.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        itemArrayList = new ArrayList<UserDetail>();
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                JSONObject dataObject = jsonArray.getJSONObject(i);
                                UserDetail userDetail = new Gson().fromJson(dataObject.getString("data"), UserDetail.class);
                                userDetail.setId(dataObject.getString("formId"));
                                itemArrayList.add(userDetail);
                            } catch (Exception e) {
