...
public class FacilitatorActivityAllSurvey extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private FacilitatorAllSurveyAdapter mRecyclerAdapterMaster;
    private ArrayList<FacilitatorCreates> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facilitator_all_survey);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);


        getSupportActionBar().setTitle("Facilitator Details");
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FacilitatorActivityAllSurvey.this, FacilitatorActivity.class);
        ...
        mRecyclerAdapterMaster = new FacilitatorAllSurveyAdapter(this, itemArrayList);
    ...
    private void getAllData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                "http://climatesmartcity.com/UBA/get_gpdpfacilitator.php", new Response.Listener<String>() {
            @Override
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                FacilitatorCreates facilitatorCreates = new Gson().fromJson(dataObject.getString("data"), FacilitatorCreates.class);
                                facilitatorCreates.setId(dataObject.getString("formId"));
                                itemArrayList.add(facilitatorCreates);
                            } catch (Exception e) {
                                Log.e("xxxxxxxxxxx", e.toString());
                            }
                        }
                        getSupportActionBar().setSubtitle(String.valueOf(itemArrayList.size()) + " Details");
