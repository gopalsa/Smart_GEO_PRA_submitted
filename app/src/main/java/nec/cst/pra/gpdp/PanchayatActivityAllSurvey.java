...
public class PanchayatActivityAllSurvey extends AppCompatActivity {


    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private PanchayatAllSurveyAdapter mRecyclerAdapterMaster;
    private ArrayList<PanchayatBean> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_all_survey_gpdp);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);


        getSupportActionBar().setTitle("Panchayat Details");
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PanchayatActivityAllSurvey.this, PanchayatActivity.class);
        ...
        mRecyclerAdapterMaster = new PanchayatAllSurveyAdapter(this, itemArrayList);
    ...
    private void getAllData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                "http://climatesmartcity.com/UBA/get_GPDPpanchayat.php", new Response.Listener<String>() {
            @Override
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                PanchayatBean panchayatBean = new Gson().fromJson(dataObject.getString("data"), PanchayatBean.class);
                                panchayatBean.setId(dataObject.getString("formId"));
                                itemArrayList.add(panchayatBean);
                            } catch (Exception e) {
