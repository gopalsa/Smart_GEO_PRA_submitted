...
public class GalleryActivityAllSurvey extends AppCompatActivity {



    private ProgressDialog pDialog;
    private RecyclerView mastersList;
    private GalleryAllSurveyAdapter mRecyclerAdapterMaster;
    private ArrayList<GalleryBean> itemArrayList = new ArrayList<GalleryBean>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gallery_all_survey);
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GalleryActivityAllSurvey.this, GalleryActivity.class);
        ...
        mRecyclerAdapterMaster = new GalleryAllSurveyAdapter(this, itemArrayList);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        itemArrayList = new ArrayList<GalleryBean>();
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                JSONObject dataObject = jsonArray.getJSONObject(i);
                                GalleryBean galleryBean = new Gson().fromJson(dataObject.getString("data"), GalleryBean.class);
                                galleryBean.setId(dataObject.getString("formId"));
                                itemArrayList.add(galleryBean);
                            } catch (Exception e) {
