...
public class Survey implements Serializable {
    ...
    public String distanceDistrictHQ;
    public String villageArea;
    public String arableLandAgricultureArea;
    public String forestArea;
    public String housingAbadiArea;
    public String areaUnderWaterBodies;
    public String commonLandsArea;
    public String wasteLand;
    public String waterTable;
    public String geoTag;
    public ArrayList<Need> needs;
    public String distanceHighway;
    public String villageConnectedPaccaRoad;
    public String roadLength;
    public String yearOfConstruction;
    public String schemeConstructed;
    public String presentStatus;
    public String lengthOfKachha;
    public String lengthOfPakkka;
    public String modeOfTransport;
    public String frequencyOfAvailable;
    public String typeOfForest;
    public String communityForest;
    public String governmentForest;
    public String mainForestTrees;
    public String energySpecies1;
    public String energyArea1;
    public String energySpecies2;
    public String energyArea2;
    public String energySpecies3;
    public String energyArea3;
    public ArrayList<Electricity> electricityArrayList;
